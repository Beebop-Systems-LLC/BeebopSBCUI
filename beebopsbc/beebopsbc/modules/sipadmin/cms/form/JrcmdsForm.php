<?php
include_once (MODULE_PATH.'/sipadmin/service/asipto/libs/cmds/serjr.php');
include_once (MODULE_PATH.'/sipadmin/service/siremisJRCommands.php');

class JrcmdsForm extends EasyForm
{
   	protected $localService = "sipadmin.service.siremisJRCommands";
   	...
   	protected function renderHTML()
   	{
		...
		<FORM id="micmds_form" action="" method="post">
			<INPUT type="text" class="mdc-text-field--outlined" name="cmd" size="40"/>
			<INPUT type="submit" class="mdc-button mdc-button--raised" name="submit" value="Run"/>
			<INPUT type="reset" class="mdc-button mdc-button--raised"/>
		</FORM>
		<br />';
		...
		'<br />
		<br />
		<FORM style="float:center;" action="" method="post" class="change_form">
			<SELECT name="cmdid" class="mdc-list">';
